...
// Specify URL Env
// ==================
// Example: Commandline url= whatever env here
var baseUrl = "https://secure.patriotpowerhub.com/index.php";
if (process.env.url === "dev") {
  baseUrl = "http://pph.dev.4patriots.net";
} else if (process.env.url === "stage") {
  baseUrl = "https://pph.stage.4patriots.net";
}
exports.config = {
  //
  // ==================
  ...
  screenshotPath: "screenShotFails",
  //
